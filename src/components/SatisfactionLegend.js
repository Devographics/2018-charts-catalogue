        ...
        return (
            <div className="satisfaction-legend">
                ...
                <div className="satisfaction-legend_item">
                    ...
                    />
                    Heard of it<br/>Would like to learn
                </div>
                <div className="satisfaction-legend_item">
                    <span
                        className="satisfaction-legend_item_chip"
                    ...
                    />
                    Never heard of it<br/>Not sure what it is
                </div>
            </div>
        )
    }
